...
<body>
	...
	<?php
		...
		if(mysqli_query($conn, $sql)){
			$update_sql = "UPDATE meds SET med_qty = med_qty + $qty WHERE med_id = $mid";

			if(mysqli_query($conn, $update_sql)) {
				echo "<p style='font-size:8;'>Purchase details successfully added, and inventory updated!</p>";
			} else {
				echo "<p style='font-size:8;color:red;'>Error updating inventory.</p>";
			}		
		} else{
